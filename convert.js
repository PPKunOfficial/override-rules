/*!
powerfullz 的 Substore 订阅转换脚本 v2.5.13
  ...
  function buildProxyGroups({
    ...
    const groups = [
      ...
      },
      {
        ...
        type: "select",
        "include-all": true,
        proxies: hasTW && hasHK ? ["DIRECT", PROXY_GROUPS.SELECT, `台湾节点`, `香港节点`] : defaultProxiesDirect
      },
      {
  ...
  var init_rules = __esm({
    "src/rules.ts"() {
      ...
      baseRules = [
        ...
        `GEOSITE,douyin,${PROXY_GROUPS.DOMESTIC_SERVICE}`,
        ...
        `GEOSITE,cn,${PROXY_GROUPS.DOMESTIC_SERVICE}`,
    ...
    "src/rule_providers.ts"() {
      ...
      ruleProviders = {
        ...
        TikTok: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/PPKunOfficial/override-rules@main/ruleset/TikTok.list`,
        ...
        EHentai: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/PPKunOfficial/override-rules@main/ruleset/EHentai.list`,
        ...
        SteamFix: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/PPKunOfficial/override-rules@main/ruleset/SteamFix.list`,
        ...
        GoogleFCM: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/PPKunOfficial/override-rules@main/ruleset/FirebaseCloudMessaging.list`,
        ...
        AdditionalFilter: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/PPKunOfficial/override-rules@main/ruleset/AdditionalFilter.list`,
        ...
        AdditionalCDNResources: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/PPKunOfficial/override-rules@main/ruleset/AdditionalCDNResources.list`,
        ...
        Weibo: {
          ...
          format: "text",
          interval: 86400,
          url: `${CDN_URL}/gh/PPKunOfficial/override-rules@main/ruleset/Weibo.list`,
